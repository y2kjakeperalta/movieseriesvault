fetch('https://api.sampleapis.com/movies/animation').then((data) => {
    ...
    completedata.map((values) => {
        ...
        <div class="card-body">
          ...
          <a href="https://www.imdb.com/title/${values.imdbId}/?ref_=nv_sr_srsg_0"><button type="button" class="btn btn-danger dark btn-download btn-lg" >Search Movie Details</button></a>
        </div>
      </div>`
    });
